...
pub enum Message {
    ...
    // Sent when a background worker decoded and resized the cover into raw RGBA pixels.
    CoverDecoded { source_id: String, book_id: String, rgba: Vec<u8>, width: u32, height: u32 },
